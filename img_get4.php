...
<div class="slider" >
  <?php foreach ($images as $i => $img): ?>
    <?php echo "<div>"; ?>
  <!-- <a href="data:image/jpeg;base64,<?=base64_encode($img)?>"  data-lity data-lity-target="data:image/jpeg;base64,<?=base64_encode($img)?>"> -->
  <a data-lity href="download.jpg" >YouTubeをLityで表示</a>
